...
public class AppUserConfig {
	...
	CommandLineRunner commandLineRunner(
		...
		return (args -> {
			LocalDateTime dateTimeTask2 = LocalDateTime.of(2021, 5, 5, 11, 30, 0).plusMinutes(40);
			LocalDateTime dateTimeTask1 = LocalDateTime.of(2021, 5, 6, 11, 30, 0).plusMinutes(20);
			Task task1 =new Task("task1",LocalDateTime.of(2021, 5, 6, 11, 30, 0),dateTimeTask1,20);
			Task task2 =new Task("task2",LocalDateTime.of(2021, 5, 5, 11, 30, 0),dateTimeTask2,40);
			...
			LocalDateTime dateTimeTask3 = LocalDateTime.of(2021, 5, 4, 11, 30, 0).plusMinutes(20);
			LocalDateTime dateTimeTask4 = LocalDateTime.of(2021, 5, 4, 11, 30, 0).plusMinutes(40);
			Task task3 =new Task("task3",LocalDateTime.of(2021, 5, 6, 11, 30, 0),dateTimeTask3,20);
			Task task4 =new Task("task4",LocalDateTime.of(2021, 5, 4, 11, 30, 0),dateTimeTask4,40);
